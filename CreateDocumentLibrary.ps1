...
.EXAMPLE
   .\CreateDocumentLibrary.ps1 -SiteCollection <site_collection_URL> -LibraryName <Name_for_the_Library>
.EXAMPLE
   .\CreateDocumentLibrary.ps1 -SiteCollection https://<tenantName>.sharepoint.com/sites/test -LibraryName "My New Library"
.NOTES
