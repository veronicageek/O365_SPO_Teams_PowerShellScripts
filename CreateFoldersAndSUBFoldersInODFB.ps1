...
.EXAMPLE
   .\CreateFoldersAndSUBFoldersInODFB.ps1 -AdminAccount <admin@domain.com> -SPOAcct <SCA_on_ODFB> -TenantName <Name_of_the_O365_Tenant> -CsvFileLocation <CsvFile_Location> 
.EXAMPLE
   .\CreateFoldersAndSUBFoldersInODFB.ps1 (if no parameters are entered, you will be prompted for them)
